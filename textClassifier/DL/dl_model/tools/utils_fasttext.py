...
class Dataset(object):
    def __init__(self, config):
        ...
        self._fasttextEmbedingSource=config._fasttextEmbedingSource
    ...
    def _genTrainEvalData(self, x, y, word2idx, rate):
        ...
        # trainReviews, evalReviews, trainLabels, evalLabels = train_test_split(reviews, y, test_size=0.2, random_state=0)
    ...
    def _getWordEmbedding(self, words):
        ...
        wordVec = fasttext.load_model(self._fasttextEmbedingSource)
        vocab = []
        wordEmbedding = []
        # 添加 "pad" 和 "UNK", 
        vocab.append("PAD")
        ...
        for word in words:
            try:
                vector = wordVec.get_word_vector(word)
                vocab.append(word)
